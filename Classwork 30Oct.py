...
paul = paul.lower().translate(str.maketrans('','',string.punctuation)).split( )

paul = set (paul)

print (len(paul), "paul's review")
...
jane = jane.lower().translate(str.maketrans('','',string.punctuation)).split( )

jane = set(jane)

print (len(jane), "jane's review")
...
kate = kate.lower().translate(str.maketrans('','',string.punctuation)).split( )
kate = set(kate)

print (len(kate), "kate's review")
...
nick = nick.lower().translate(str.maketrans('','',string.punctuation)).split( )
nick = set(nick)

print (len(nick), "nick's review")
